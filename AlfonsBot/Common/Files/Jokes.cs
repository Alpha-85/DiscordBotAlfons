namespace AlfonsBot.Common.Files;

public static class Jokes
{
    public static string PopulateDictionary()
    {
        var data = @"
        [
        ...
        ""My mom died when we could not remember her blood type. As she died, she kept telling us to “be positive,” but it’s hard without her.""#
        ...
        ""What do you call a dog with no legs? Does not matter what you call him, he won’t come anyway.""#
